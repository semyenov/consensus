...
export namespace $default {
  export interface BaseObject extends std.$Object {
    "description": string;
    "name": string;
  }
  ...
  export interface User extends BaseObject, Auditable {
    "identity": ext.auth.Identity;
    "email": string;
    "assigned_issues": issue.Issue[];
    "total_issues": number;
    "workload": number;
...
export type BaseObject = $default.BaseObject;
...
export namespace issue {
  export interface Comment extends $default.Auditable {
    "author": $default.User;
    "issue": Issue;
    "content": string;
    "is_edited"?: boolean | null;
  }
  export interface Issue extends $default.BaseObject, $default.Auditable, tag.Taggable {
    "author": $default.User;
    "status": IssueStatus;
    "assignee"?: $default.User | null;
    ...
    "time_spent"?: edgedb.Duration | null;
    "milestone"?: project.Milestone | null;
    "comments": Comment[];
    "labels": Label[];
  }
  export type IssuePriority = "Low" | "Medium" | "High" | "Critical";
  export type IssueStatus = "Open" | "Closed" | "Merged" | "Reopened" | "Locked" | "Unlocked" | "Labeled" | "Unlabeled" | "Milestoned" | "Demilestoned";
  export interface Label extends $default.Auditable, $default.BaseObject {
    "issues": Issue[];
    "color": string;
  }
}
export namespace project {
  export interface Milestone extends $default.BaseObject, $default.Auditable {
  ...
  export type MilestoneStatus = "Planned" | "InProgress" | "Completed" | "Overdue";
  export interface Project extends $default.BaseObject, $default.Auditable, tag.Taggable {
    "budget": finance.Budget;
    "issues": issue.Issue[];
    "owner": $default.User;
  ...
  export interface Sprint extends $default.Auditable, $default.BaseObject {
    "issues": issue.Issue[];
  ...
  export interface Team extends $default.BaseObject {
    "owner": $default.User;
...
export namespace finance {
  export interface Monetary extends std.$Object {
    "amount": string;
  }
  export interface Budget extends $default.BaseObject, $default.Auditable, Monetary {
    "owner": $default.User;
    "total_amount": string;
  ...
  export interface Expense extends $default.BaseObject, $default.Auditable, Monetary {
    "created_by": $default.User;
    "budget": Budget;
  }
  export interface Payment extends $default.BaseObject, $default.Auditable, Monetary {
    "approved_by": $default.User;
    "recipient": $default.User;
    "associated_issue": issue.Issue;
...
export namespace tag {
  export interface Taggable extends std.$Object {
    "tags": Tag[];
  }
  export interface Tag extends $default.BaseObject {}
}
...
export namespace search {
  export interface VectorSearchable extends std.$Object {
...
export interface types {
  ...
  "search": {
    "VectorSearchable": search.VectorSearchable;
  };
}
