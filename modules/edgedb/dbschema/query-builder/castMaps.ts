...
import type * as _search from "./modules/search";
import type * as _schema from "./modules/schema";
import type * as _project from "./modules/project";
import type * as _issue from "./modules/issue";
import type * as _fts from "./modules/fts";
import type * as _finance from "./modules/finance";
...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _search.$EmbeddingVector ? _search.$EmbeddingVector : 
  ...
  T extends _project.$ProjectStatus ? _project.$ProjectStatus : 
  T extends _project.$MilestoneStatus ? _project.$MilestoneStatus : 
  T extends _issue.$IssueStatus ? _issue.$IssueStatus : 
  T extends _issue.$IssuePriority ? _issue.$IssuePriority : 
  ...
  T extends _finance.$PaymentStatus ? _finance.$PaymentStatus : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _std.$Endian ?
    ...
    never
  :
  A extends _search.$EmbeddingVector ?
    B extends _search.$EmbeddingVector ?
    B
    :
    never
  :
  ...
  A extends _schema.$AccessKind ?
    ...
    never
  :
  A extends _project.$ProjectStatus ?
    B extends _project.$ProjectStatus ?
    B
    :
    never
  :
  A extends _project.$MilestoneStatus ?
    B extends _project.$MilestoneStatus ?
    B
    :
    never
  :
  A extends _issue.$IssueStatus ?
    B extends _issue.$IssueStatus ?
    B
    :
    never
  :
  A extends _issue.$IssuePriority ?
    B extends _issue.$IssuePriority ?
    B
    :
    never
  :
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _finance.$PaymentStatus ?
    B extends _finance.$PaymentStatus ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "search::EmbeddingVector") {
    if(b.__name__ === "search::EmbeddingVector") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "project::ProjectStatus") {
    if(b.__name__ === "project::ProjectStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "project::MilestoneStatus") {
    if(b.__name__ === "project::MilestoneStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "issue::IssueStatus") {
    if(b.__name__ === "issue::IssueStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "issue::IssuePriority") {
    if(b.__name__ === "issue::IssuePriority") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "finance::PaymentStatus") {
    if(b.__name__ === "finance::PaymentStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
