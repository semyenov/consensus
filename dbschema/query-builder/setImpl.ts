...
import type { $expr_Set, LooseTypeSet, getCardsFromExprs, getSharedParentPrimitiveVariadic, getTypesFromExprs, getTypesFromObjectExprs, mergeObjectTypesVariadic } from './set'
...
function set(..._exprs: any[]) {
  ...
  const exprs: $.TypeSet[] = _exprs.map((expr) => {
    return castMaps.literalToTypeSet(expr)
  })
