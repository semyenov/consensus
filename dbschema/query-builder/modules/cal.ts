...
> = $.$expr_Function<
  $local_datetime,
  $.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>, $.cardutil.paramCardinality<P3>>, $.cardutil.paramCardinality<P4>>, $.cardutil.paramCardinality<P5>>, $.cardutil.paramCardinality<P6>>
>
/**
...
> = $.$expr_Function<
  $relative_duration,
  $.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.optionalParamCardinality<NamedArgs['years']>, $.cardutil.optionalParamCardinality<NamedArgs['months']>>, $.cardutil.optionalParamCardinality<NamedArgs['days']>>, $.cardutil.optionalParamCardinality<NamedArgs['hours']>>, $.cardutil.optionalParamCardinality<NamedArgs['minutes']>>, $.cardutil.optionalParamCardinality<NamedArgs['seconds']>>, $.cardutil.optionalParamCardinality<NamedArgs['microseconds']>>
>
/**
...
> = $.$expr_Function<
  $date_duration,
  $.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.optionalParamCardinality<NamedArgs['years']>, $.cardutil.optionalParamCardinality<NamedArgs['months']>>, $.cardutil.optionalParamCardinality<NamedArgs['days']>>
>
/**
...
function to_date_duration(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('cal::to_date_duration', args, _.spec, [{ args: [], namedArgs: { years: { typeId: '00000000-0000-0000-0000-0000000001ff', optional: true, setoftype: false, variadic: false }, months: { typeId: '00000000-0000-0000-0000-0000000001ff', optional: true, setoftype: false, variadic: false }, days: { typeId: '00000000-0000-0000-0000-0000000001ff', optional: true, setoftype: false, variadic: false } }, returnTypeId: '00000000-0000-0000-0000-000000000112' }])
...
function time_get(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('cal::time_get', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-00000000010d', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-0000000001ff' }])
...
function date_get(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('cal::date_get', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-00000000010c', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-0000000001ff' }])
...
function duration_normalize_hours(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('cal::duration_normalize_hours', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-000000000111', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000111' }])
