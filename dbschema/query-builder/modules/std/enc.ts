...
> = $.$expr_Function<
  _std.$str,
  $.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<NamedArgs['alphabet']>>, $.cardutil.optionalParamCardinality<NamedArgs['padding']>>
>
...
function base64_encode(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::enc::base64_encode', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-000000000102', optional: false, setoftype: false, variadic: false }], namedArgs: { alphabet: { typeId: '5ca96424-93ba-560a-994b-7820c9623e3d', optional: true, setoftype: false, variadic: false }, padding: { typeId: '00000000-0000-0000-0000-000000000109', optional: true, setoftype: false, variadic: false } }, returnTypeId: '00000000-0000-0000-0000-000000000101' }])
