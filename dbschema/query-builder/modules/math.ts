...
function abs(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('math::abs', args, _.spec, [{ args: [{ typeId: '04976545-1176-5536-8673-c9f7d18d581b', optional: false, setoftype: false, variadic: false }], returnTypeId: '04976545-1176-5536-8673-c9f7d18d581b' }])
...
function log(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('math::log', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-000000000108', optional: false, setoftype: false, variadic: false }], namedArgs: { base: { typeId: '00000000-0000-0000-0000-000000000108', optional: false, setoftype: false, variadic: false } }, returnTypeId: '00000000-0000-0000-0000-000000000108' }])
