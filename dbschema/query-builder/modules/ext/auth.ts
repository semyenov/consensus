...
export type $IdentityλShape = $.typeutil.flatten<$AuditableλShape & {
  ...
  '<identity[is __default::current_user]': $.LinkDesc<___default.$current_user, $.Cardinality.Many, {}, false, false, false, false>
...
function signing_key_exists(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('ext::auth::signing_key_exists', args, _.spec, [{ args: [], returnTypeId: '00000000-0000-0000-0000-000000000109' }])
...
> = $.$expr_Function<
  $.NamedTupleType<{ header: _std.$str, payload: _std.$str, signature: _std.$str }>,
...
function jwt_parse_08a86a788cea56a9b555b4a881b5e569(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('ext::auth::_jwt_parse', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '7bfb0106-9442-58d3-9fe3-3c204e331351' }])
...
function jwt_verify_75faa5ad758d5502bb04da9b92b99f58(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('ext::auth::_jwt_verify', args, _.spec, [{ args: [{ typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }, { typeId: '14113b4e-86a8-5b08-8ee9-9cfc1c7dc1e8', optional: true, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-00000000010f' }])
...
> } = { ClientTokenIdentity: _.syntax.makeGlobal(
  ...
  $.Cardinality.AtMostOne,
) as any, client_token: _.syntax.makeGlobal(
  'ext::auth::client_token',
