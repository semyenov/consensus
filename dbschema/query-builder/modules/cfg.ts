...
> = $.$expr_Function<
  _std.$json,
  $.cardutil.multiplyCardinalities<$.cardutil.optionalParamCardinality<NamedArgs['sources']>, $.cardutil.optionalParamCardinality<NamedArgs['max_source']>>
>
...
function get_config_json(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('cfg::get_config_json', args, _.spec, [{ args: [], namedArgs: { sources: { typeId: 'bb221d39-09f1-507e-8851-62075bb61823', optional: true, setoftype: false, variadic: false }, max_source: { typeId: '00000000-0000-0000-0000-000000000101', optional: true, setoftype: false, variadic: false } }, returnTypeId: '00000000-0000-0000-0000-00000000010f' }])
