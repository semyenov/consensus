...
const overloadDefs: {
  [opKind in 'Infix' | 'Prefix' | 'Postfix' | 'Ternary']: Record<string, any[]>
} = {
  Infix: {
    '=': [
    ...
    'or': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000109', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000109', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'and': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000109', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000109', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    '+': [
    ...
    'in': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'not in': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'union': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000001', returnTypemod: 'SetOfType' }],
    'except': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000001', returnTypemod: 'SetOfType' }],
    'intersect': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000001', returnTypemod: 'SetOfType' }],
    ...
    'like': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'ilike': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'not like': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'not ilike': [{ kind: 'Infix', args: [{ typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000101', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
  },
  Postfix: {},
  Prefix: {
    'not': [{ kind: 'Prefix', args: [{ typeId: '00000000-0000-0000-0000-000000000109', optional: false, setoftype: false, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    '+': [
    ...
    'exists': [{ kind: 'Prefix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000109' }],
    'distinct': [{ kind: 'Prefix', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000001', returnTypemod: 'SetOfType' }],
  },
  Ternary: {
    if_else: [{ kind: 'Ternary', args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000109', optional: false, setoftype: false, variadic: false }, { typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: true, variadic: false }], returnTypeId: '00000000-0000-0000-0000-000000000001', returnTypemod: 'SetOfType' }],
  },
}
...
function op(...args: any[]) {
  ...
  else if (args.length === 6 // Functional-style if-then-else
    && typeof args[0] === 'string' && typeof args[2] === 'string' && typeof args[4] === 'string') {
    op = `${args[0]}_${args[4]}`
  ...
  if (!defs) {
    throw new Error(`No operator exists with signature: ${args.map((arg) => {
 return `${arg}`
})
.join(', ')}`)
  }
